...
|---|---:|---|---|
| article_001 | 10 | Includes organizations (`Հայաստանի Ազգային Գրադարանի`) | Minor cleanup |
...
| article_009 | 7 | Includes regions/places (`Նյու Յորք`, `Արևելյան Հայաստանի`) | Needs cleanup |
| article_010 | 1 | Very low recall; weak candidate (`Արաբերեն Պարսկերեն`) | Needs cleanup |
...
2. Improve recall for article_010 by allowing a second extraction pass tuned for dictionary-style Armenian names.
